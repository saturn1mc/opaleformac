...
- (NSURL *)applicationFilesDirectory
{
    ...
    return [appSupportURL URLByAppendingPathComponent:@"CaM.Opale"];
}
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Opale" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *url = [applicationFilesDirectory URLByAppendingPathComponent:@"Opale.sqlite"];
...
- (NSManagedObjectContext *)managedObjectContext
{
    ...
    if (!coordinator) {
        ...
        NSError *error = [NSError errorWithDomain:@"OPALE_ERROR_DOMAIN" code:9999 userInfo:dict];
        [[NSApplication sharedApplication] presentError:error];
        return nil;
    }
